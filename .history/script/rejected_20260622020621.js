...
function rejected5() {
    ...
    localStorage.setItem("rejectedCount", data5);

    document.getElementById("counter").innerText = data5;

    const statusButton = document.getElementById("button-bar5");
...
let data6 = Number(localStorage.getItem("rejectedCount")) || 0;

document.getElementById("counter").innerText = data6;

function rejected6() {

    data6 = data6 + 1;

    localStorage.setItem("rejectedCount", data6);

    document.getElementById("counter").innerText = data6;

    const statusButton = document.getElementById("button-bar6");
...
let data7 = Number(localStorage.getItem("rejectedCount")) || 0;

document.getElementById("counter").innerText = data7;
...
function rejected7() {
    ...
    const statusButton = document.getElementById("button-bar7");
...
let data8 = Number(localStorage.getItem("rejectedCount")) || 0;

document.getElementById("counter").innerText = data8;

function rejected8() {

    data8 = data8 + 1;

    localStorage.setItem("rejectedCount", data8);

    document.getElementById("counter").innerText = data8;

    const statusButton = document.getElementById("button-bar8");
